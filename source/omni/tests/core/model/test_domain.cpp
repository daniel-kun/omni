...
BOOST_AUTO_TEST_CASE (allDomains)
{
    ...
    context c;
    auto literal1 = std::make_shared <literal_expression> (std::make_shared <builtin_literal <int>> (c, 10));
    auto literal2 = std::make_shared <literal_expression> (std::make_shared <builtin_literal <int>> (c, 20));
    ...
    BOOST_CHECK_EQUAL (domain::block,
                       block ().getDomain ());
    BOOST_CHECK_EQUAL (domain::builtin_literal,
                       literal1->getLiteral ()->getDomain ());
    ...
    BOOST_CHECK_EQUAL (domain::literal_expression,
                       literal1->getDomain ());
