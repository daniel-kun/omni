...
**/
omni::core::type::function_it omni::core::type::functionsBegin ()
{
...
Returns a begin-iterator for the functions in this type.
**/
omni::core::type::function_const_it omni::core::type::functionsBegin () const
{
	return _impl->_functions.begin ();
}
...
**/
omni::core::type::function_it omni::core::type::functionsEnd ()
{
...
Returns an end-iterator for the functions in this type.
**/
omni::core::type::function_const_it omni::core::type::functionsEnd () const
{
	return _impl->_functions.end ();
}
...
{
	static std::string const result ("type");
	return result;
}
