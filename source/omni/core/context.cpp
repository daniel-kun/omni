...
**/
std::shared_ptr <omni::core::context_part> omni::core::context::findPartById (omni::core::id id)
{
...
**/
omni::core::id omni::core::context::createId (omni::core::domain domain)
{         
...
**/
std::shared_ptr <omni::core::function> omni::core::context::createFunction (std::string const & name, std::shared_ptr <type> returnType, std::shared_ptr <block> body)
{
...
**/
void omni::core::context::addFunction (std::shared_ptr <omni::core::function_prototype> function)
{
...
**/
std::shared_ptr <omni::core::function_prototype> omni::core::context::findFunctionByName (std::string const & name)
{
    id_to_parts_map & functionMap (_parts [domain::function]);
...
**/
bool omni::core::context::removeFunction (std::shared_ptr <omni::core::function_prototype> function)
{
    id_to_parts_map & functionMap (_parts [domain::function]);
...
**/
std::shared_ptr <omni::core::type> omni::core::context::sharedType (type_class typeClass)
{
...
**/
void omni::core::context::setEntryPoint (std::shared_ptr <function> function)
{
...
**/
void omni::core::context::emitAssemblyFile (std::string const & fileName, const context_emit_options & options)
{
...
**/
void omni::core::context::emitAssemblyFile (std::ostream & stream, const context_emit_options & options)
{
    std::string tmp;
...
**/
void omni::core::context::emitAssemblyFile (llvm::raw_ostream & stream, const context_emit_options & options)
{
...
**/
void omni::core::context::emitObjectFile (std::ostream & stream, const context_emit_options & options)
{
    std::string tmp;
    llvm::raw_string_ostream rawStream (tmp);
...
**/
void omni::core::context::emitObjectFile (llvm::raw_ostream & stream, const context_emit_options & options)
{
    llvm::Module module ("test", * _llvmContext);
...
**/
void omni::core::context::emitObjectFile (std::string const & fileName, const context_emit_options & options)
{
    std::string errorInfo;
...
**/
void omni::core::context::emitSharedLibraryFile (std::string const & fileName, const context_emit_options & options)
{
