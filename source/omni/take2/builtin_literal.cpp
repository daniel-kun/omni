...
template <>
omni::take2::builtin_literal <unsigned char>::builtin_literal (context & context, unsigned char value) :
...
template <>
llvm::Value * omni::take2::builtin_literal <signed char>::llvmValue ()
{
...
template <>
llvm::Value * omni::take2::builtin_literal <unsigned char>::llvmValue ()
{
    switch (getType ()->getTypeClass ()) {
